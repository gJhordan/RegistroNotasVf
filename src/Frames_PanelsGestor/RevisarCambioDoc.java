 ...
 */
public class RevisarCambioDoc extends javax.swing.JPanel {
    ...
    public RevisarCambioDoc() {
        initComponents();
        Tbl.CargarTablaSolicitudDoc(TblSolDoc, "solcambiodocente", null);
    ...
    private void initComponents() {
        ...
        TblSolDoc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IDSolicitud", "IDSeccion", "Cod Docente", "Motivo", "Estado"
            }
        ));
        ...
        LblDocente.setText("-");
        LblDocente.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Codigo del Docente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void TblSolDocMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblSolDocMousePressed
        ...
        if (fila != -1) {
            ...
            String sSeccion = TblSolDoc.getValueAt(fila, TblSolDoc.getColumnModel().getColumnIndex("IDSeccion")).toString();
            String CodDoc = TblSolDoc.getValueAt(fila, TblSolDoc.getColumnModel().getColumnIndex("Cod Docente")).toString();
    ...
    private void BtnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnProcesarActionPerformed
        ...
        if (estadonuevo.equals("Rechazado")) {
            SD.setIDSol(Integer.parseInt(LblIDSolicitud.getText()));  
            SD.setEstado(estadonuevo);
            ...
            VESDoc.setIDSol(Integer.parseInt(LblIDSolicitud.getText()));
            VESDoc.setNroSeccion(Integer.parseInt(LblSeccion.getText()));
            VESDoc.setCodDocenteAntiguo(LblDocente.getText());
            VESDoc.setEstado(estadonuevo);
            ProcCambioDoc PCD = new ProcCambioDoc();
            mostrarTipo(PCD);
        }
